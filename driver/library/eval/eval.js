...
function doEval(evalStr) {
	...
	let program = acorn.parse(
		...
		onToken: doComment.bind(comments, accumulatedComments),
		onComment: onComment.bind(comments, accumulatedComments),
	})
	...
	return onInstruction(programCallstack, program)
		.then(onEval)
}
...
//   when debugging.
function doInstruction(runContext, resolve, reject) {

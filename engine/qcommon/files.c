...
#ifdef __WASM__
	// TODO: displaying file-system in 3D is more of a Jarvis thing to do
	Cmd_AddCommand( "edit", Sys_Edit );
	Cmd_SetCommandCompletionFunc( "edit", FS_CompleteFileName );
#else
	// TODO: on native, probably open system default text editor
	//   OR, use ace9 virtual renderer in game engine, 
	//   other editors are starting to use GL pipeline
#endif
#ifdef USE_ASYNCHRONOUS
